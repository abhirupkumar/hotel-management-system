...
const ShopNow = () => {
    return (
        <div className='sm:bg-[rgba(0,0,0,.5)] sm:py-[4rem] sm:px-[3rem] absolute md:top-[30%] top-[20%] z-20 flex flex-col items-center space-y-4'>
            ...
            <Link className="flex mr-2 text-white border-0 py-2 px-3 focus:outline-none bg-[#1a4ffd] hover:bg-[#1440d3] rounded sm:text-base sm:font-medium text-xs" to="rooms">Checkout Our Rooms</Link>
        </div>
    )
}
